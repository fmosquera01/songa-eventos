...
// El QR se genera con la IP ACTUAL detectada por DHCP.
// No existe ninguna IP fija como 192.168.1.90 en esta página.
$qrUrl = $urlMovil
    ? 'https://api.qrserver.com/v1/create-qr-code/?size=300x300&margin=10&data=' . rawurlencode($urlMovil)
    : '';
?>
<!doctype html>
<html lang="es">
<head>
    ...
    <style>
        *{box-sizing:border-box}
        ...
        .qrbox img{width:300px;height:300px;display:block;image-rendering:auto}
        ...
        @media(max-width:750px){body{padding:15px}.grid{grid-template-columns:1fr}.qrbox{min-width:280px;min-height:280px}.qrbox img{width:250px;height:250px}}
    </style>
</head>
<body>
        ...
        <?php if ($wifi): ?>
            <div class="grid">
                <div>
                    ...
                    <p class="nota">Si el router cambia la IP por DHCP, recarga esta página. El QR se volverá a generar con la nueva IP.</p>
                </div>
                ...
                <div class="qr">
                    ...
                    <div class="qrbox">
                        <img
                            ...
                            alt="Código QR para <?= htmlspecialchars($urlMovil, ENT_QUOTES, 'UTF-8') ?>"
                            onerror="this.style.display='none';this.nextElementSibling.style.display='block';"
                        >
                        <div class="aviso" style="display:none;">
                            No se pudo cargar el generador de QR. Verifica que el servidor tenga acceso a Internet para generar la imagen.
                        </div>
                    </div>
                    <p>El código contiene exactamente la URL de la IP Wi-Fi detectada actualmente.</p>
                </div>
            </div>
        <?php else: ?>
